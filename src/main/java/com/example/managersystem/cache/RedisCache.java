package com.example.managersystem.cache;
...
public class RedisCache {
     ...
     * @param <T>
     */
    public <T> void redisExecute(final String lua_script, final List<String> key, final String value) {

        redisTemplate.execute(new DefaultRedisScript<>(lua_script, Boolean.class), key, value);
    ...
    public <T> long setCacheList(final String key, final List<T> dataList) {
        ...
        final Long count = this.redisTemplate.opsForList().rightPushAll(key, dataList);
    ...
    public void delCacheMapValue(final String key, final String hkey) {
        ...
        final HashOperations hashOperations = this.redisTemplate.opsForHash();
    ...
    public void incrementCacheMapValue(final String key, final String hKey, final int v) {
        ...
        this.redisTemplate.boundHashOps(key).increment(hKey, v);
    }
